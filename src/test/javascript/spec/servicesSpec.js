...
describe('Services Tests', function () {
    ...
    describe('GeneralErrorService', function () {
        var GeneralErrorService, $rootScope;
        beforeEach(inject(function (_$rootScope_, _GeneralErrorService_) {
            $rootScope = _$rootScope_;
            GeneralErrorService = _GeneralErrorService_;
        }));

        it('should display httpResponse.data.message',function(){
            //When
            GeneralErrorService.displayGeneralError({
                data : {
                    message: 'error'
                }
            });
        ...
        it('should display httpResponse',function(){
            //When
            GeneralErrorService.displayGeneralError('error');
    ...
    describe('UserRoomsService', function () {
        var UserRoomsService;
        beforeEach(inject(function (_UserRoomsService_) {
    ...
    describe('NavigationService', function () {
        var $rootScope, $q, Room, NavigationService, UserRoomsService, GeneralErrorService;
        beforeEach(inject(function (_$rootScope_, _$q_, _Room_, _NavigationService_, _UserRoomsService_, _GeneralErrorService_) {
            $rootScope = _$rootScope_;
            $q = _$q_;
            Room = _Room_;
        ...
        it('should display error when failing to load room', function () {
            //Given
            var errorCapture;
            spyOn(GeneralErrorService,'displayGeneralError').and.callFake(function(error){
                errorCapture = error;
            });
            var $scope = $rootScope.$new();
            var rejected = $q.defer();
        ...
        it('should quit room back hom', function () {
            ...
            //Then
            expect($scope.state.currentRoom).toEqual({});
    ...
    describe('WebSocketService', function () {
        var $rootScope, WebSocketService, ParticipantService;
        beforeEach(inject(function (_$rootScope_, _WebSocketService_, _ParticipantService_) {
            $rootScope = _$rootScope_;
    ...
    describe('ChatService', function () {
        var $rootScope, $q, Message, WebSocketService, ChatService, GeneralErrorService;
        beforeEach(inject(function (_$rootScope_, _$q_, _Message_, _WebSocketService_, _ChatService_, _GeneralErrorService_) {
            $rootScope = _$rootScope_;
            $q = _$q_;
            Message = _Message_;
            WebSocketService = _WebSocketService_;
        ...
        it('should raise error when posting empty message', function () {
            ...
            spyOn(GeneralErrorService,'displayGeneralError');
            //When
            ChatService.postMessage($scope);

            //Then
            expect($scope.newMessage.content).toBe('');
            expect(GeneralErrorService.displayGeneralError).toHaveBeenCalledWith('Hey dude, post a non blank message ...');
        });
    });
